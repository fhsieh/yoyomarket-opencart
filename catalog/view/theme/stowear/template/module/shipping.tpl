		...
		success: function(json) {
			...
			if (json['error']) {
				if (json['error']['warning']) {
					$('.center-column > form').before('<div class="alert alert-danger"><i class="fa fa-exclamation-circle"></i> ' + json['error']['warning'] + '<button type="button" class="close" data-dismiss="alert">&times;</button></div>');
