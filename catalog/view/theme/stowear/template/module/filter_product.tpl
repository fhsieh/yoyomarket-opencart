	...
	<div class="tab-content">
		...
		<div class="tab-pane <?php if($s == 0) { echo 'active'; } ?>" id="<?php echo $tab['title'].'-'.$id.'-'.$s; ?>">
			...
			$(document).ready(function() {
			  var owl<?php echo $id . '_' . $s; ?> = $(".col-sm-12 > .filter-product #myCarousel<?php echo $id.'-'.$s; ?> .carousel-inner, .col-sm-9 > .filter-product #myCarousel<?php echo $id.'-'.$s; ?> .carousel-inner, .col-sm-6 > .filter-product #myCarousel<?php echo $id.'-'.$s; ?> .carousel-inner");
