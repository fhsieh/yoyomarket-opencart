	...
	<div class="slider-header">
		...
		<div id="top-bar" class="<?php if($theme_options->get( 'top_bar_layout' ) == 1) { echo 'full-width'; } else { echo 'fixed'; } ?>">
			...
			<div class="background">
				...
				<div class="pattern">
					<div class="container" style="padding-left: 20px; padding-right: 20px;"><?php /* yym_custom */ ?>
						<div class="row">
							<!-- Top Bar Left -->
							<div class="col-md-3 hidden-sm hidden-xs"><?php /* yym_custom */ ?>
								<!-- Welcome text -->
							...
							<!-- Top Bar Right -->
							<div class="col-md-9" id="top-bar-right"><?php /* yym_custom */ ?>
								...
								<ul class="top-bar-links">
									...
									<?php /* yym_custom ?><li><a href="<?php echo $checkout; ?>"><?php echo $text_checkout; ?></a></li><?php */ ?>
									<?php if ($logged) { ?>
									...
									<?php } else { ?>
									<li><a href="<?php echo $register; ?>"><i class="fa fa-user"></i> <?php if($theme_options->get( 'register_text', $config->get( 'config_language_id' ) ) != '') { echo $theme_options->get( 'register_text', $config->get( 'config_language_id' ) ); } else { echo 'Create an account'; } ?></a></li>
									<li><a href="<?php echo $login; ?>"><i class="fa fa-sign-in"></i> <?php if($theme_options->get( 'login_text', $config->get( 'config_language_id' ) ) != '') { echo $theme_options->get( 'login_text', $config->get( 'config_language_id' ) ); } else { echo 'Login'; } ?></a></li>
									<?php } ?>
								</ul>
							</div>
						</div>
					...
					<div class="container">
						<div class="row">
							...
							<div class="col-sm-4" id="header-left">
								<?php if ($logo) { ?>
								<!-- Logo -->
								<div class="logo"><a href="<?php echo $home; ?>"><img src="<?php echo $logo; ?>" srcset="<?php echo $logo; ?> 1x, <?php echo str_replace('.png', '@2x.png', $logo); ?> 2x" title="<?php echo $name; ?>" alt="<?php echo $name; ?>" /></a></div>
								<?php } ?>
							</div>
							...
							<div class="col-sm-8" id="header-right">
								...
								<ul class="header-links">
									...
									<?php } else { ?>
									<li><a href="<?php echo $login; ?>"><?php if($theme_options->get( 'login_text', $config->get( 'config_language_id' ) ) != '') { echo $theme_options->get( 'login_text', $config->get( 'config_language_id' ) ); } else { echo 'Login'; } ?></a></li>
									<li><a href="<?php echo $register; ?>"><?php if($theme_options->get( 'register_text', $config->get( 'config_language_id' ) ) != '') { echo $theme_options->get( 'register_text', $config->get( 'config_language_id' ) ); } else { echo 'Create an account'; } ?></a></li>
									<?php } ?>
								</ul>
								<?php */ ?>
