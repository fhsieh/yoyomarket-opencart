...
<?php foreach ($fields as $field) { ?>
  ...
  <?php } elseif ($field == 'zone') { ?>
    <?php if (!empty(${'field_' . $field}['display'])) { ?>
	<div class="form-group clearfix<?php echo !empty(${'field_' . $field}['required']) ? ' required' : ''; ?>">
  ...
  <?php } else { ?>
	<?php if (!empty(${'field_' . $field}['display'])) { ?>
	<div<?php echo $field == 'postcode' ? ' id="shipping-postcode-required"' : ''; ?> class="form-group clearfix<?php echo !empty(${'field_' . $field}['required']) ? ' required' : ''; ?>">
...
<div id="custom-field-shipping">
  ...
  <?php if ($custom_field['location'] == 'address') { ?>
	<div class="form-group clearfix custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>" id="shipping-custom-field<?php echo $custom_field['custom_field_id']; ?>">
...
$('#custom-field-shipping .custom-field[data-sort]').detach().each(function() {
	if ($(this).attr('data-sort') >= 0 && $(this).attr('data-sort') <= $('#shipping-new .form-group').length) {
		$('#shipping-new .form-group').eq($(this).attr('data-sort')).before(this);
	}

	if ($(this).attr('data-sort') > $('#shipping-new .form-group').length) {
