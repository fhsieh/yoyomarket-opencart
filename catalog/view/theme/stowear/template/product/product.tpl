...
<div itemscope itemtype="http://data-vocabulary.org/Product">
  	...
  	<div class="row">
  		<div class="col-sm-<?php if($theme_options->get( 'custom_block', 'product_page', $config->get( 'config_language_id' ), 'status' ) == 1) { echo 9; } else { echo 12; } ?>">
  			<div class="row" id="quickview_product">
			    ...
			    <?php } ?>
			    <?php $image_grid = 7; $product_center_grid = 5; // yym
			      ...
			      <div class="row">
				      ...
				      <div class="col-sm-<?php if($theme_options->get( 'position_image_additional' ) == 2) { echo 10; } else { echo 12; } ?>">
					      ...
					      <div class="product-image <?php if($theme_options->get( 'product_image_zoom' ) != 2) { if($theme_options->get( 'product_image_zoom' ) == 1) { echo 'inner-cloud-zoom'; } else { echo 'cloud-zoom'; } } ?>">
					     	 ...
					     	 <a href="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>" id="ex1"><img src="<?php echo $thumb; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" id="image" itemprop="image" data-zoom-image="<?php echo $popup; ?>" style="margin: 0 auto;" /></a><?php /* yym_custom */ ?>
					      </div>
					  	 <?php } else { ?>
				      ...
				      <div class="col-sm-12">
					      <div class="thumbnails clearfix">
					      		...
					      		<?php if($theme_options->get( 'product_image_zoom' ) != 2 && $thumb) { ?>
					      		<a href="<?php echo $popup; ?>" data-image="<?php echo $thumb; ?>" data-zoom-image="<?php echo $popup; ?>"><img style="margin: 0 5px 5px 0; border: 1px solid #d9d9d9; padding: 2px;" src="<?php echo $thumb; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" /></a>
					      		<?php } ?>
						        <?php foreach ($images as $image) { ?>
						        <a href="<?php echo $image['popup']; ?>" data-image="<?php echo $image['popup']; ?>" data-zoom-image="<?php echo $image['popup']; ?>"><img style="margin: 0 5px 5px 0; border: 1px solid #d9d9d9; padding: 2px;" src="<?php echo $image['thumb']; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" /></a>
						        <?php } ?>
			     ...
			     <div id="product">
			      ...
			      <div class="cart">
			        ...
			        <div class="links">
			        	...
			        	<?php /* yym ?><a onclick="compare.add('<?php echo $product_id; ?>');"><i class="fa fa-exchange"></i> <?php echo $button_compare; ?></a><?php */ ?>
			        </div>
  ...
  <div id="tabs" class="htabs">
  	<?php $i = 0; foreach($tabs as $tab) { $i++;
  		...
  		// if($tab['content'] == 'attribute') { $id = 'tab-attribute'; } // yym_custom
