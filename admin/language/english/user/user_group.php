...
// Text
$_['text_success']      = 'You have modified user groups.';
...
// Error
$_['error_permission']  = 'You do not have permission to modify user groups.';
$_['error_name']        = 'User Group Name must be between 3 and 64 characters.';
$_['error_user']        = 'This user group cannot be deleted as it is currently assigned to %s users.';