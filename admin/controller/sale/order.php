...
class ControllerSaleOrder extends Controller {
	...
	public function info() {
        ...
        // yym_custom: add qosu to order/info
...
//			$this->document->setTitle($this->language->get('heading_title'));
			$this->document->setTitle($this->language->get('text_title') . $order_info['order_id'] . ': ' . $order_info['firstname'] . ' ' . $order_info['lastname']); // yym_custom

//			$data['heading_title'] = $this->language->get('heading_title');
			$data['heading_title'] = $this->language->get('text_title') . $order_info['order_id']; // yym_custom
			...
			$data['text_loading'] = $this->language->get('text_loading');
            $data['text_delivery_preference'] = $this->language->get('text_delivery_preference'); // yym_custom
            $data['text_delivery_telephone'] = $this->language->get('text_delivery_telephone'); // yym_custom
            $data['text_shipping_date'] = $this->language->get('text_shipping_date'); // yym_custom
            ...
            $data['shipping_date'] = $order_info['shipping_date']; // yym_custom
            $data['shipping_dow'] = $order_info['shipping_dow']; // yym_custom
			...
			$data['order_id'] = $this->request->get['order_id'];
            $data['order_status_id'] = $order_info['order_status_id']; // yym_custom: add qosu to order/info
	...
	public function history() {
		...
		$data['column_date'] = $this->language->get('column_date'); // yym_custom
		$data['column_status'] = $this->language->get('column_status');
