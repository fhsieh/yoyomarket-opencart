...
class ControllerSettingSetting extends Controller {
	...
	protected function validate() {
		...
		if ((utf8_strlen($this->request->post['config_telephone']) < 6) || (utf8_strlen($this->request->post['config_telephone']) > 32)) {
		...
		if ((utf8_strlen($this->request->post['config_encryption']) < 2) || (utf8_strlen($this->request->post['config_encryption']) > 32)) {
