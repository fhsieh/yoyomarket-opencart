...
class ControllerCommonMenu extends Controller {
	public function index() {
        ...
        $data['text_inventory'] = $this->language->get('text_inventory'); // yym_custom
		...
		$data['report_inventory'] = $this->url->link('report/inventory', 'token=' . $this->session->data['token'], 'SSL'); // yym_custom
