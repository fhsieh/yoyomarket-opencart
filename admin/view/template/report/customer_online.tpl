            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-right"><?php if ($customer['customer_id']) { ?>
                  <a href="<?php echo $customer['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a><!-- yym --></td>
                <?php } else { ?>
                <button type="button" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary btn-xs" disabled="disabled"><i class="fa fa-pencil"></i></button><!-- yym -->
                <?php } ?>
              </tr>
              <?php } ?>
              <?php } else { ?>
