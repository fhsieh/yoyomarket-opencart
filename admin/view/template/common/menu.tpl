<ul id="menu">
  ...
  <li id="catalog"><a class="parent"><i class="fa fa-table fa-fw"></i> <span><?php echo $text_catalog; ?></span></a>
    <ul>
  ...
  <li><a class="parent"><i class="fa fa-paint-brush fa-fw"></i> <span><?php echo $text_design; ?></span></a>
    <ul>
  ...
  <li><a class="parent"><i class="fa fa-bullhorn fa-fw"></i> <span><?php echo $text_marketing; ?></span></a>
    <ul>
  ...
  <li id="reports"><a class="parent"><i class="fa fa-bar-chart-o fa-fw"></i> <span><?php echo $text_reports; ?></span></a>
    <ul>
      ...
      <li><a href="<?php echo $report_inventory; ?>"><?php echo $text_inventory; ?></a></li>
      <!--
