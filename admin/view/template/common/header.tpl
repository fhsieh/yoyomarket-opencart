...
<?php } ?>
<link href="/image/catalog/assets/icon-admin.png" rel="icon"/>
  ...
  <ul class="nav pull-right">
    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown"><span class="label label-danger pull-left"><?php echo $alerts; ?></span> <i class="fa fa-bell fa-lg"></i></a>
      <ul class="dropdown-menu dropdown-menu-right alerts-dropdown">
        ...
        <li><a href="<?php echo $complete_status; ?>"><span class="label label-primary pull-right"><?php echo $complete_status_total; ?></span><?php echo $text_complete_status; ?></a></li>
