  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right"><a href="<?php echo $add; ?>" data-toggle="tooltip" title="<?php echo $button_add; ?>" class="btn btn-primary"><i class="fa fa-plus"></i> <?php echo $button_add; ?></a><!-- yym -->
        <button type="button" data-toggle="tooltip" title="<?php echo $button_delete; ?>" class="btn btn-danger" onclick="confirm('<?php echo $text_confirm; ?>') ? $('#form-review').submit() : false;"><i class="fa fa-trash-o"></i> <?php echo $button_delete; ?></button><!-- yym -->
      </div>
          ...
          <div class="table-responsive">
            <table class="table table-bordered table-hover table-condensed table-striped"><!-- yym -->
              <thead>
                ...
                <tr class="filters">
                  <td></td>
                  <td><input type="text" name="filter_product" value="<?php echo $filter_product; ?>" id="input-product" class="form-control input-sm" /></td>
                  <td><input type="text" name="filter_author" value="<?php echo $filter_author; ?>" id="input-author" class="form-control input-sm" /></td>
                  <td></td>
                  <td>
                  ...
                  <td><button type="button" id="button-filter" class="btn btn-default btn-sm"><i class="fa fa-filter fa-fw"></i></button></td>
                </tr>
              </thead>
              <tbody>
                <?php if ($reviews) { ?>
                ...
                <tr>
                  ...
                  <td class="text-right"><a href="<?php echo $review['edit']; ?>" data-toggle="tooltip" title="<?php echo $button_edit; ?>" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a><!-- yym --></td>
                </tr>
                <?php } ?>
                <?php } else { ?>
                <tr>
...
$(document).ready(function() {
  $('#form-review table > tbody > tr').on('click', function(e) {
