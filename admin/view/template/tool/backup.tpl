  ...
  <div class="page-header">
    <div class="container-fluid">
      <div class="pull-right">
        <button type="submit" form="form-backup" data-toggle="tooltip" title="<?php echo $button_backup; ?>" class="btn btn-primary"><i class="fa fa-download"></i> <?php echo $button_backup; ?></button><!-- yym -->
        <button type="submit" form="form-restore" data-toggle="tooltip" title="<?php echo $button_restore; ?>" class="btn btn-default"><i class="fa fa-upload"></i> <?php echo $button_restore; ?></button><!-- yym -->
      </div>
