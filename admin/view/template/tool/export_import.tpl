  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-upload"></i> Export / Import</h3>
      </div>
                ...
                <tr id="range_type">
                  <td style="vertical-align:top;"><?php echo $entry_range_type; ?><span class="help"><?php echo $help_range_type; ?></span><br />
                    ...
                    <div class="form-group">
                      <label for="min" class="col-sm-1 control-label">
                        <span class="id"><?php echo $entry_start_id; ?></span>
                        <span class="page"><?php echo $entry_start_index; ?></span>
                      </label>
                      <div class="col-sm-2">
                        <input type="text" name="min" value="<?php echo $min; ?>" class="form-control" />
                      </div>
                    </div>
                    <div class="form-group">
                      <label for="max" class="col-sm-1 control-label">
                        <span class="id"><?php echo $entry_end_id; ?></span>
                        <span class="page"><?php echo $entry_end_index; ?></span>
                      </label>
                      <div class="col-sm-2">
                        <input type="text" name="max" value="<?php echo $max; ?>" class="form-control" />
                      </div>
                    </div>
                  </td>
                </tr>
